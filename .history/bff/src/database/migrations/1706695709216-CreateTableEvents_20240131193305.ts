  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "edgedb"."events" ("id" SERIAL PRIMARY KEY, "event_time" TIMESTAMP, "event_type" VARCHAR(255), "camera_location" JSONB,
       "image_video" VARCHAR(255), "priority_level" VARCHAR(50), "detection_detail" TEXT, "event_description" TEXT, "camera_id" INT(100), "network_info" JSONB, "admin_info" JSONB, resolution JSONB, additional_note TEXT)`,
      undefined,
    );
  }
